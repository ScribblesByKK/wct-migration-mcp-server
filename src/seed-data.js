...
export const KNOWN_API_MAPPINGS = [
  ...
  { old_api: 'RadialProgressBar', old_package: 'Microsoft.Toolkit.Uwp.UI.Controls', status: 'direct_rename', new_api: 'RadialProgressBar', new_package: 'CommunityToolkit.WinUI.Controls', new_namespace: 'CommunityToolkit.WinUI.Controls', notes: 'Namespace changed.' },

...
export const KNOWN_API_MAPPINGS = [
  ...
  { old_api: 'GridSplitter', old_package: 'Microsoft.Toolkit.Uwp.UI.Controls', status: 'direct_rename', new_api: 'GridSplitter', new_package: 'CommunityToolkit.WinUI.Controls.Sizers', new_namespace: 'CommunityToolkit.WinUI.Controls', notes: 'Moved to dedicated Sizers package. API re-written but defaults are compatible.', breaking_changes: 'Install CommunityToolkit.WinUI.Controls.Sizers instead of the generic Controls package.' },
  { old_api: 'HeaderedContentControl', old_package: 'Microsoft.Toolkit.Uwp.UI.Controls', status: 'direct_rename', new_api: 'HeaderedContentControl', new_package: 'CommunityToolkit.WinUI.Controls.HeaderedControls', new_namespace: 'CommunityToolkit.WinUI.Controls', notes: 'Moved to dedicated HeaderedControls package.' },
  { old_api: 'HeaderedItemsControl', old_package: 'Microsoft.Toolkit.Uwp.UI.Controls', status: 'direct_rename', new_api: 'HeaderedItemsControl', new_package: 'CommunityToolkit.WinUI.Controls.HeaderedControls', new_namespace: 'CommunityToolkit.WinUI.Controls', notes: 'Moved to dedicated HeaderedControls package.', breaking_changes: 'Orientation property removed. Customize ItemsPanel instead.' },
  { old_api: 'HeaderedTreeView', old_package: 'Microsoft.Toolkit.Uwp.UI.Controls', status: 'direct_rename', new_api: 'HeaderedTreeView', new_package: 'CommunityToolkit.WinUI.Controls.HeaderedControls', new_namespace: 'CommunityToolkit.WinUI.Controls', notes: 'Moved to dedicated HeaderedControls package.' },
  ...
  { old_api: 'Menu', old_package: 'Microsoft.Toolkit.Uwp.UI.Controls', status: 'moved_to_winui', new_api: 'MenuBar', new_package: 'Microsoft.WinUI', new_namespace: 'Microsoft.UI.Xaml.Controls', notes: 'Menu is now part of WinUI. Use MenuBar instead.', usage_example: '```xml\n<MenuBar>\n  <MenuBarItem Title="File">\n    <MenuFlyoutItem Text="Open" />\n  </MenuBarItem>\n</MenuBar>\n```', breaking_changes: 'Complete API change. Menu → MenuBar, MenuItem → MenuBarItem.' },
  { old_api: 'MenuItem', old_package: 'Microsoft.Toolkit.Uwp.UI.Controls', status: 'moved_to_winui', new_api: 'MenuBarItem', new_package: 'Microsoft.WinUI', new_namespace: 'Microsoft.UI.Xaml.Controls', notes: 'MenuItem maps to WinUI MenuBarItem (top-level) or MenuFlyoutItem (sub-items).', breaking_changes: 'MenuItem → MenuBarItem for top-level items; sub-items use MenuFlyoutItem.' },
